...
class ProductController extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        try {
            ...
            $brands  = $this->brandService->getActiveBrands()->load('translation');
            $vendors = Vendor::with('user:name,id')->where('status', 1)->get();
            $taxes   = Tax::with('translation')->where('status', 1)->get();
    ...
    public function productGalleryStore(Request $request, $id)
    {
        ...
        try {
            ...
            return $this->redirectWithMessage(RedirectType::UPDATE->value, 'admin.product-gallery', [
                'id' => $id,
            ], [
