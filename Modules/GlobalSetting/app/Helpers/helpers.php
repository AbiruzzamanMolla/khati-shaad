...
if (!function_exists('timezone')) {
    function timezone()
    {
        return Cache::has('setting') ? Cache::memo()->get('setting')->timezone ?? config('app.timezone') : config('app.timezone');
    }
}
...
if (!function_exists('timeFormat')) {
    function timeFormat()
    {
        return Cache::has('setting') ? Cache::memo()->get('setting')->time_format ?? 'h:i A' : 'h:i A';
    }
}
...
if (!function_exists('dateFormat')) {
    function dateFormat()
    {
        return Cache::has('setting') ? Cache::memo()->get('setting')->date_format ?? 'Y-m-d' : 'Y-m-d';
    }
}
...
if (!function_exists('checkCredentials')) {
    ...
    function checkCredentials()
    {
        ...
        if (Cache::has('setting') && $settings = Cache::memo()->get('setting')) {
