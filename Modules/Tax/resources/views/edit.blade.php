                ...
                <div class="mt-4 row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form
                                    action="{{ route('admin.tax.update', ['tax' => $tax->id, 'code' => $code]) }}"
                                    method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <x-admin.form-input id="percentage" name="percentage" data-translate="true"
                                                    type="number" value="{{ old('slug', $tax->percentage) }}"
                                                    label="{{ __('Percentage') }}"
